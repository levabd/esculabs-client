namespace Client.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Client.Context.BalderContext>
    {
        ...
        protected override void Seed(Client.Context.BalderContext context)
        {
